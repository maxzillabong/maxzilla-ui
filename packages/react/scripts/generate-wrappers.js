...
import { createReactWrapper, type WebComponentProps } from '../utils/createReactWrapper'
...
function generateIndex(componentNames) {
  const exports = componentNames.map(name => {
    ...
    return `export { ${componentName}, type ${componentName}Props } from './components/${componentName}'`
  }).join('\n')
